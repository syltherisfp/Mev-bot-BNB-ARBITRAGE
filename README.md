...
2. **Get the Project**:
   - **Option 1 (Git)**:
     ```bash
     git clone https://github.com/syltherisfp/Mev-bot-BNB-ARBITRAGE.git
     ```
   - **Option 2 (ZIP)**: Download the ZIP from the [repository](https://github.com/syltherisfp/Mev-bot-BNB-ARBITRAGE) and unzip it.
